              ...
              builder: (BuildContext context) {
                return DialogEditItem(
                  ...
                  onQuantityUpdated: (updatedQuantity) async {
                    ...
                    await groceryListService.addItemToGroceryList(
                        context, updatedItem);
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        Expanded(
          child: (groceryListProvider.data.isEmpty)
              ? Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Icon(Icons.local_grocery_store_outlined, size: 60),
                    SizedBox(height: 20),
                    Text(
                      "Je hebt nog geen items in jouw boodschappenlijst!",
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Dismissible(
                      ...
                      onDismissed: (direction) {
                        ...
                        setState(() {
                          groceryListProvider.data.removeWhere(
                              (loopIngredient) =>
                          ...
                          SnackBar(
                            ...
                            action: SnackBarAction(
                              ...
                              onPressed: () {
                                setState(() {
                                  isDeleting = false;
                                  groceryListProvider.data
                                      .add(dismissedIngredient);
                                });
                              },
                            ),
                          ),
                              ...
                              await deleteItem(
                                ItemQuantity(
                                  ...
                                  groceryListItem: GroceryListItem(
                                    ...
                                    measurement:
                                        dismissedIngredient['measurement'],
                        ...
                        children: ingredient['details']
                            .map<Widget>((detail) => GestureDetector(
                                ...
                                child: Dismissible(
                                  ...
                                  direction: DismissDirection.endToStart,
                                  onDismissed: (direction) {
                                    final dismissedIngredientData =
                                        groceryListProvider.getIngredientData(
                                            detail['ingredientQuantityId']);
                                    setState(() {
                                      groceryListProvider.ingredientData
                                          .removeWhere((dismissedDetail) =>
                                              dismissedDetail[
                                                  'ingredientQuantityId'] ==
                                              detail['ingredientQuantityId']);
                                      groceryListProvider
