...
//     var response =
//         await groceryListService.fetchGroceryListByAccountId(groceryListId.toString());
//
//     if (response != null) {
...
//       for (var ingredient in parsedIngredientData) {
//         String key =
//             '${ingredient['ingredientName']}_${ingredient['measurement']}'; // Unique key for grouping
